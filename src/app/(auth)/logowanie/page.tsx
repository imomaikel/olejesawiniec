...
const AuthPage = () => {
  return (
    <div className="w-full h-screen flex items-center justify-center relative flex-col">
      <div className="relative w-[350px] md:w-[400px] flex justify-center">
        <Image src="/signatureBlack.png" width={300} height={300} alt="podpis" className="object-center" />
      </div>
