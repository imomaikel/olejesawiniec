...
const TagControl = ({
	...
	const { mutate: detachTag, isLoading: detachLoading } =
		trpc.panel.detachTag.useMutation({
			onSuccess: (message) => {
				refetchProduct();
	...
	const { mutate: appendTag, isLoading: appendLoading } =
		trpc.panel.appendTag.useMutation({
	...
	return (
		<div>
			...
			<p className='text-muted-foreground'>
				Kliknij na tag aby go dodać lub usunąć
			</p>
