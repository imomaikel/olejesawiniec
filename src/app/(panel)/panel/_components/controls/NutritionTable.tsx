...
const NutritionTable = ({ product, refetch }: TNutritionTable) => {
  ...
  const calculate = (
    ...
    const value =
      type === 'calories' ? fat * 9 + (protein + carbo) * 4 + fiber * 2 : fat + protein + carbo + fiber + sodium;
  ...
  const handleChange = (newValue: string, field: keyof NutritionFact) => {
    ...
    const polyunsaturatedFat = field === 'polyunsaturatedFat' ? value : data.polyunsaturatedFat;
    const monounsaturatedFat = field === 'monounsaturatedFat' ? value : data.monounsaturatedFat;
    const carbohydrateSugar = field === 'carbohydrateSugar' ? value : data.carbohydrateSugar;

    const totalCalories = calculate(fat, protein, carbo, fiber, sodium, 'calories');
  ...
  const { mutate: updateCalories, isLoading } = trpc.panel.updateCalories.useMutation({
    onSuccess: (message) => {
      if (message === 'OK') {
      ...
      <Table>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell>
              <Input type="number" value={data.fat} onChange={(e) => handleChange(e.target.value, 'fat')} />
            </TableCell>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableCell>
              <Input
                ...
                onChange={(e) => handleChange(e.target.value, 'monounsaturatedFat')}
              />
            </TableCell>
          </TableRow>
          <TableRow>
            ...
            <TableCell>
              <Input
                ...
                onChange={(e) => handleChange(e.target.value, 'polyunsaturatedFat')}
              />
            </TableCell>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableCell>
              <Input
                ...
                onChange={(e) => handleChange(e.target.value, 'carbohydrateSugar')}
              />
            </TableCell>
          </TableRow>
          <TableRow>
            ...
            <TableCell>
              <Input type="number" value={data.fiber} onChange={(e) => handleChange(e.target.value, 'fiber')} />
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>Białko</TableCell>
            <TableCell>
              <Input type="number" value={data.protein} onChange={(e) => handleChange(e.target.value, 'protein')} />
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>Sól</TableCell>
            <TableCell>
              <Input type="number" value={data.sodium} onChange={(e) => handleChange(e.target.value, 'sodium')} />
            </TableCell>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableCell className={cn(data.status !== 'OK' && 'text-destructive font-medium')}>{data.status}</TableCell>
          </TableRow>
        </TableBody>
      </Table>
