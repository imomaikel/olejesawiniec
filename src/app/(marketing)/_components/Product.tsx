        ...
        <div className="absolute z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-6 border-2 rounded-lg bg-background">
          <div className="flex">
            <div className="w-[300px] max-w-[300px] max-h-[300px] h-[300px]">
              <Image loading="eager" alt="olej" src={image} width={300} height={300} />
            </div>
            <div className="h-[300px] w-[1px] bg-black/20" />
            <div className="flex flex-col px-6 space-y-2">
              <div className="text-2xl font-medium">{label}</div>
              <div className="text-primary text-3xl font-bold">{formatPrice(price)}</div>
              <ul>
              ...
              <div className="flex space-x-4">
                <Button className="w-full rounded-full py-4">Dodaj do koszyka</Button>
                <Button className="flex flex-0.5" variant="ghost" onClick={handleClose}>
                  Zamknij
                </Button>
              </div>
            </div>
